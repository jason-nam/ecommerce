export default function DropDown({which, register, country}){
    ...
    else if (which === "province" && country==="CA") {
        return <select className="cinfo-input" id="cinfo-province" name="cinfo-province"
                    defaultValue={""}
    ...
    } else if (which === "province" && country==="US") {
        return <select className="cinfo-input" id="cinfo-province" name="cinfo-province" 
                    defaultValue={""}
                    { ...register("province", { required: "State required"})} >
                    <option value=""></option>
    ...
    else if (which === "bprovince" && country==="CA") {
        return <select className="cinfo-input" id="binfo-province" name="binfo-province"
                    defaultValue={""}
    ...
    } else if (which === "bprovince" && country==="US") {
        return <select className="cinfo-input" id="binfo-province" name="binfo-province" 
                    defaultValue={""}
                    { ...register("bprovince", { required: "State required"})} >
                    <option value=""></option>
                    <option value="AK">Alaska</option>
                    <option value="AL">Alabama</option>
                    <option value="AR">Arkansas</option>
